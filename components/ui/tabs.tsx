...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-xl p-[3px] text-muted-foreground bg-white/5",
      className
    )}
    {...props}
  />
